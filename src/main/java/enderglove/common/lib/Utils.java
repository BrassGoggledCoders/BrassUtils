...
public class Utils
{
	...
	/**
	 * Determines what a block's drops are without
	 * checking for fortune values (useful for the
	 * Flame Touch enchantment).
	 * 
	...
	/**
	 * Determines whether the given block stored
	 * in the item stack can be smelted.
	...
	/**
	 * Plays a sound at the given location. It's
	 * an ugly method, that's why I moved it here.
	 * 
	...
	/**
	 * Determines whether the player is wearing an
	 * instance of an Ender Glove.
	 * 
	...
	/**
	 * Creates a new item-based, metadata-inclusive
	 * item stack for the given block and metadata.
	 * Relays the metadata to item subtypes.
	 * 
	...
	/**
	 * Only used for BlockRedstoneOre. If you use the
	 * above method, it'll crash your game. Guaranteed.
	 * 
	 * @return new item stack
	 */
