...
{	
	/**
	 * Grabs the Ender Chest inventory relative to a given
	 * player.
	 * 
	...
	/**
	 * Grabs the first empty slot that the item stack can be
	 * placed into.
	 * 
	...
	/**
	 * Determines if the given inventory is empty by checking if
	 * it can add the given item stack to the inventory.
	 * 
	 * @param inv - the inventory to check
	 * @param is - the item stack to put in the inventory
