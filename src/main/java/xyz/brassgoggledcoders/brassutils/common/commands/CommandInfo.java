...
public class CommandInfo extends BaseCommand implements ICommand
{
	...
	public void executeCommand(ICommandSender sender, String[] stringarray)
	{
		...
		{
			// throw new WrongUsageException("Command usage is /info <target>.
			// Available targets are: 'player' and 'world'", new Object[0]);
		}
		...
		{
			// throw new WrongUsageException("Could not get info about specified
			// thing", new Object[0]);
		}
	}
