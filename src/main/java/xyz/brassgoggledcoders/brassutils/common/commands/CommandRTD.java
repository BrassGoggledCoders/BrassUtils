	...
	public void processCommand(ICommandSender icommandsender, String[] astring)
	{
		if (icommandsender instanceof EntityPlayer)
		{
			...
			if (r == 1)
			{
				...
				// player.getCommandSenderEntity().getName() + " rolled the dice
				// and got laughed at");
			}
			else if (r == 2)
			{
				...
				// PlayerUtils.sendChatToServer("Player " +
				// player.getCommandSenderEntity() + " rolled the dice and got
				// cured");
			}
			else if (r == 3)
			{
			...
			else if (r == 5)
			{
				...
				// PlayerUtils.sendChatToServer("Player " +
				// player.getCommandSenderEntity() + " rolled the dice and was
				// forced to sneak for a while");
			}
			else if (r == 6)
			{
			...
			else if (r == 8)
			{
				...
				// PlayerUtils.sendChatToServer("Player " +
				// player.getCommandSenderEntity() + " rolled the dice and went
				// invisible");
			}
			else if (r == 9)
			{
			...
			else if (r == 11)
			{
				...
				// PlayerUtils.sendChatToServer("Player " +
				// player.getCommandSenderEntity() + " rolled the dice and got a
				// dirty head");
			}
			else if (r == 12)
			{
				...
				// PlayerUtils.sendChatToServer("Player " +
				// player.getCommandSenderEntity() + " rolled the dice and
				// dropped what they were holding");
			}
			else if (r == 13)
			{
			...
			else if (r == 21)
			{
				...
				// "Player " + player.getCommandSenderEntity() + " rolled the
				// dice and was given some dynamite! Watch out for them!");
			}
			else if (r == 22)
			{
				player.worldObj.setBlockState(
						new BlockPos(player.getPosition().getX(), player.getPosition().getY() + 20, player.getPosition().getZ()),
						Blocks.anvil.getDefaultState());
				// PlayerUtils.sendChatToServer("Player " +
				// player.getCommandSenderEntity() + " rolled the dice and had
			...
			else if (r == 24)
			{
				...
				// player.getCommandSenderEntity() + " rolled the dice and was
				// teleported to "
				// + player.worldObj.getClosestPlayer(player.posX, player.posY,
				// player.posZ, -1).getCommandSenderEntity());
			}
			else if (r == 25)
			{
				player.setInWeb();
			...
			else if (r == 28)
			{
				...
				// PlayerUtils.sendChatToServer("Player " +
				// player.getCommandSenderEntity() + " rolled the dice and set
				// the time to night");
			}
			else if (r == 29)
			{
				// Utils.spawnEntityAtCoords(player.worldObj, new
				// EntityPig(player.worldObj), player.serverPosX,
				// player.serverPosY, player.serverPosZ);
				// PlayerUtils.sendChatToServer("Player " +
				// player.getCommandSenderEntity() + " rolled the dice and
				// spawned a pig");
			}
