...

{
	...
	// @SideOnly(Side.CLIENT)
	// @Override
	// public void getSubBlocks(Item item, CreativeTabs par2CreativeTabs, List
	// par3List)
	// {
	...
	// * against the blocks color. Note only called when first determining what
	// to
	// * render.
	// */
	// @Override
	// @SideOnly(Side.CLIENT)
	// public int colorMultiplier(IBlockAccess p_149720_1_, int p_149720_2_, int
	// p_149720_3_, int p_149720_4_)
	// {
	// int l = 0;
	// int i1 = 0;
	// int j1 = 0;
	...
	// {
	// int i2 = p_149720_1_.getBiomeGenForCoords(p_149720_2_ + l1, p_149720_4_ +
	// k1).getBiomeFoliageColor(p_149720_2_ + l1, p_149720_3_,
	// p_149720_4_ + k1);
	// l += (i2 & 16711680) >> 16;
	// i1 += (i2 & 65280) >> 8;
	// j1 += i2 & 255;
	...
	// @Override
	// @SideOnly(Side.CLIENT)
	// public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int
	// p_149734_3_, int p_149734_4_, Random p_149734_5_)
	// {
	// if (p_149734_1_.canLightningStrikeAt(p_149734_2_, p_149734_3_ + 1,
	// p_149734_4_)
	// && !World.doesBlockHaveSolidTopSurface(p_149734_1_, p_149734_2_,
	// p_149734_3_ - 1, p_149734_4_) && (p_149734_5_.nextInt(15) == 1))
	// {
