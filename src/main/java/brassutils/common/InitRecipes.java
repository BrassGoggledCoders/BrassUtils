...
public class InitRecipes
{
	public static void init()
	{
		...
		GameRegistry.addRecipe(new ItemStack(Blocks.end_portal_frame, 12), new Object[]{"SES", "SDS", "SSS", 'S', Blocks.end_stone, 'E', Items.ender_eye, 'D', Blocks.dragon_egg, 'S', Items.nether_star});
		...
		GameRegistry.addShapelessRecipe(new ItemStack(Items.quartz, 4), new Object[]{new ItemStack(Blocks.quartz_block, 1, OreDictionary.WILDCARD_VALUE)});
